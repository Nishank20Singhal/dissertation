...
parser.add_argument('--dataset', required=False, default='streetlearn_osm2world', help='input dataset')
...
for epoch in range(params.num_epochs):
    ...
    for i, (input, target) in enumerate(train_data_loader):
        ...
        #print(torch.IntTensor(D_real_loss.data))
